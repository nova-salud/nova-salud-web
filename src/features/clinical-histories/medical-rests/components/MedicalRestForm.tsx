...
import { Button, Textarea, InputFile, SearchSelect, DateRangeInput, Select, Input } from '@/shared/components'
...
export const MedicalRestForm = ({ clinicalHistoryId, accidentId, attentionId, onSuccess, onCancel }: Props) => {
  ...
  const { isLoading, error, createMedicalRest } = useCreateMedicalRest()
  ...
  return (
    <form className="space-y-5" onSubmit={(e) => void handleSubmit(e)}>
      ...
      <div className="flex justify-end gap-3 pt-2">
        {onCancel ? (
          <Button type="button" variant="outline" className="w-auto" onClick={onCancel}>
            Cancelar
          </Button>
        ) : null}
        <Button
